!function(e,t,a,n,c,i,o){e.GoogleAnalyticsObject=c,e[c]=e[c]||function(){(e[c].q=e[c].q||[]).push(arguments)},e[c].l=1*new Date,i=t.createElement(a),o=t.getElementsByTagName(a)[0],i.async=1,i.src=n,o.parentNode.insertBefore(i,o)}(window,document,"script","//www.google-analytics.com/analytics.js","ga"),ga("create","UA-51504974-1","gosukiwi.github.io"),ga("send","pageview");
!function(){"use strict";var e=function(){var e=document.createElement("link");e.rel="stylesheet",e.href="http://netdna.bootstrapcdn.com/font-awesome/4.1.0/css/font-awesome.min.css";var t=document.getElementsByTagName("head")[0];t.parentNode.insertBefore(e,t)},t=requestAnimationFrame||mozRequestAnimationFrame||webkitRequestAnimationFrame||msRequestAnimationFrame;t?t(e):window.addEventListener("load",e)}();
...
$(document).ready(function(){"use strict";$("a").click(function(t){var e=$(this).attr("href");0===e.indexOf("#")&&(t.preventDefault(),$("html, body").animate({scrollTop:$(e).offset().top}))})});